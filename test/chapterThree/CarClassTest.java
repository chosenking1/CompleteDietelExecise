...
// (Car Class) Create a class called Car that includes three instance variables—a
// model (type String), a year (type String), and a price (double).
...
// Create two Car objects and display each object’s price. Then apply a 5% discount on the price of the first car
