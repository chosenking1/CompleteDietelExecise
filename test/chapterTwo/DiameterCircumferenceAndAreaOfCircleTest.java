...
//        In this chapter, you learned about integers and the type int. Java can also represent floating-point numbers that contain decimal points, such as 3.14159.
//        Write an application that inputs from the user the radius of a circle as an integer and prints the circle’s diameter, circumference and area using the floating-point value
...
public class DiameterCircumferenceAndAreaOfCircleTest {
    @Test
    void areaCanBeCalculated(){

        String result = DiameterCircumferenceAndAreaOfACircle.calculate(5);
